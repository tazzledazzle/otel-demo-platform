...
- Files: `graphql-rest-tutorial/config.json`
- Current mitigation: No sensitive keys.
- Recommendations: Keep config.json free of secrets; use env vars or a separate, gitignored file for any future credentials (e.g. API keys for demo services).
...
**Planning artifacts:**
- Files: `graphql-rest-tutorial/.planning/REQUIREMENTS.md`, `graphql-rest-tutorial/.planning/ROADMAP.md`
...
None. No application dependencies (no package.json, requirements.txt, build files). When dependencies are added (e.g. Apollo Server, Express, GraphQL-Java), pin versions and document in `graphql-rest-tutorial/.planning/codebase/STACK.md`.

## Missing Critical Features

**Phase and requirement definition:**
- Problem: ROADMAP phases and REQUIREMENTS phase requirements are not yet defined. research/README.md is a placeholder.
- Files: `graphql-rest-tutorial/.planning/ROADMAP.md`, `graphql-rest-tutorial/.planning/REQUIREMENTS.md`, `graphql-rest-tutorial/.planning/research/README.md`
- Blocks: Concrete implementation plans, task breakdown, and tutorial content (schemas, resolvers, HTTP semantics, client integration).

**Application and tutorial content:**
- Problem: No source code, no tutorial steps, no GraphQL or REST implementation.
...
| No app code       | Tutorial has no implementable content yet       | Implement phases per ROADMAP (GraphQL + REST examples) |
...
| Stack not chosen  | PROJECT.md allows "any language" and standard tooling | First phase should pick stack and document in STACK.md |
