...
- Location: `python-ml-tutorial/.planning/`
...
- Location: `python-ml-tutorial/config.json`
...
**Intended (from PROJECT.md):** Tutorial content will cover data prep → training pipelines → metrics → production considerations. Actual code layout and data flow will be defined when phases are implemented.
...
- Location: `python-ml-tutorial/.planning/PROJECT.md`
- Defines: Core value, requirements (validated/active/out of scope), context (audience, stack, deliverables), constraints, key decisions table.
...
**None.** No runnable application. Entry points will be defined when tutorial phases (e.g. labs, scripts, notebooks) are added.
